...
//        方法二：使用直接赋值
    ...
    public function get_access_token(){
        ...
        //缓存
        cache('access_token', $this->access_token, $expire_time);
        //存储access_token 和web_expires ,通过判断web_expires是否过期，然后是否请求
//        Db::table('tp_wx_user')->where(array('id'=>$this->wechat_config['id']))->save(array('web_access_token'=>$return['access_token'],'web_expires'=>$web_expires));
